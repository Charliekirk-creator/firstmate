...
An ambiguous unattested legacy identity fails closed because mutable claimant metadata cannot prove which colliding origin and key created it; absent, conflicting, foreign, or changed metadata cannot supply durable identity.
